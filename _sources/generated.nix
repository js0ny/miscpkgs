...
}:
{
  ...
  flyline = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.9.0";
      fetchSubmodules = false;
      sha256 = "sha256-bKFTAAN+A3Po0PnVv1XYQyLWqBQT3btYUUuFu7jcCXA=";
    };
  };
  forgejo-file-icons = {
    pname = "forgejo-file-icons";
    version = "a3c399c75f1443f9431ef7051dc0ec026188bc5c";
    src = fetchgit {
      url = "https://github.com/js0ny/forgejo-file-icons.git";
      rev = "a3c399c75f1443f9431ef7051dc0ec026188bc5c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-cx4lojxuk786tn8n7t0rPPYT2r/UR7qlYqqIkevMU5Q=";
    };
    date = "2026-08-28";
  };
  go-fast-note-sync = {
  ...
  jellyfin-plugin-sso = {
    ...
    version = "5.0.0.2";
    src = fetchTarball {
      url = "https://github.com/Buco7854/jellyfin-plugin-sso/releases/download/v5.0.0.2/sso-auth_5.0.0.2.zip";
      sha256 = "sha256-p6vdHnzPocdVVRJzmM0cNzG1meyRfS0Z3pWUBghd4xE=";
    };
  };
  jellyfin-plugin-sso-src = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v5.0.0.2";
      fetchSubmodules = false;
      sha256 = "sha256-08AtHYAO+/L3ahHbjCQX5jZR2Eefgb1URO+njTkDv0c=";
    };
  };
  komari = {
    pname = "komari";
  ...
  komari-agent = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.5.11";
      fetchSubmodules = false;
      sha256 = "sha256-1jemWrMcdJ4RIhcRyxmFahLQZ34Q1QSQLgO6BoHhOGw=";
    };
  };
  komari-web = {
    pname = "komari-web";
  ...
  navidrome-lyrics-bin = {
    ...
    version = "8.1.0";
    src = fetchurl {
      url = "https://github.com/J0R6IT0/navidrome-lyrics-plugin/releases/download/v8.1.0/nd-lyrics.ndp";
      sha256 = "sha256-Kd1XG6DUu3VuYsDVxZSi1+fJzOwpUPOwJ71kxzxgVxU=";
    };
  };
  noname = {
    pname = "noname";
  ...
  sops-nvim = {
    pname = "sops-nvim";
    version = "26592d8fab2a4c133d2a5d95e90d2ba54eb3c018";
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-SXlI2M2BjNKEbReqTnNXITmryAboPjQJmq1IcgAMc5A=";
    };
    date = "2026-09-12";
  };
  typst-infect-nvim = {
